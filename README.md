...
echo '[plugins."io.containerd.grpc.v1.cri".containerd.runtimes.wasm]
  runtime_type = "io.containerd.wasmtime.v1"' | docker exec -i runwasi-cluster-control-plane sh -c 'cat >> /etc/containerd/config.toml'
